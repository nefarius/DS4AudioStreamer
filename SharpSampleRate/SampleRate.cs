...
namespace SharpSampleRate
{
    public static unsafe class SampleRate
    {
        ...
        public delegate bool src_callback_t(void* cb_data, float** data);
        ...
        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern SRC_STATE_PTR src_get_name(Quality converter_type);

        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern SRC_STATE_PTR src_get_description(Quality converter_type);

        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern SRC_STATE_PTR src_get_version();
        ...
        private static extern SRC_STATE_PTR internal_src_strerror(int error);
